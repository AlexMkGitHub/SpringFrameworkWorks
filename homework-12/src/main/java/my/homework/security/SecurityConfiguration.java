    ...
    public static class ApiWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http
                    ...
                    .and()
                    .csrf().disable()
                    .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS); // Авторизация для каждых запросов! Усли эту строчку убрать, то авторизация будет сохраняться в сессии.
